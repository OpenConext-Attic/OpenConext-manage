...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		g.pDiv.innerHTML = '<div class="pDiv2"></div><div style=\'clear:both\'></div><div class="pDiv3"></div>';
		$(g.bDiv).after(g.pDiv);
		...
		if ($.browser.msie&&$.browser.version<7) $('.pButton',g.pDiv).hover(function(){$(this).addClass('pBtnOver');},function(){$(this).removeClass('pBtnOver');});
            ...
            $('.pDiv3',g.pDiv).prepend("<div class='pGroup'> <div class='pJson'><span><a href=\"/portal/gadgetcount/download/1/format/json\">Json</a></span></div> </div>  <div class='btnseparator'></div>");
